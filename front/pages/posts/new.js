...
export default function NewPostPage() {
    ...
    const onFinish = (values) => {
        ...
        const dto = {
            ...
            link: values["구매사이트 링크"] ? values["구매사이트 링크"].join(",") : "",
        };
    ...
    // view
    return (<Card title="게시글 작성" style={{ maxWidth: 600, margin: "0 auto", borderRadius: "30px", background: "#E8E8C8" }}>
        <Form onFinish={onFinish} layout="vertical"  >
            ...
            >
                <Input.TextArea rows={4} placeholder="게시글 내용을 입력하세요." style={{ borderRadius: "5px" }} />
            </Form.Item>

            <Form.Item label="해시태그" name="hashtags"  >
                <Select mode="tags" style={{ width: "100%", borderRadius: "5px" }} placeholder="해시태그 입력후 Enter" />
            </Form.Item>

            <Form.Item label="구매사이트" name="구매사이트 링크"  >
                <Select mode="tags" style={{ width: "100%", borderRadius: "5px" }} placeholder="구매사이트(URL) 입력후 Enter" />
            </Form.Item>
