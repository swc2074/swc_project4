...
import { follow, unfollow, loadFollowers, loadFollowings,
  //  updateBlock, 
  toggleFollow 
  } from '../followSaga';
...
describe('followSaga CRUD', () => {
 ...
 // 팔로우 추가
  ...
  const dispatched = [];
  axios.post.mockResolvedValue({ data: { followeeId: "2", blocked: false } }); // 서버 응답 mock
  ...
  //   const action = updateBlockRequest({ followeeId: 2,
  //     //  blocked: true 
  //     });
