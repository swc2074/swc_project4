...
import com.swc2602.dto.request.CommentRequestDto;
import com.swc2602.dto.request.FollowRequestDto;
import com.swc2602.dto.request.LikeRequestDto;
import com.swc2602.dto.request.LoginRequest;
import com.swc2602.dto.request.PostRequestDto;
import com.swc2602.dto.request.RetweetRequestDto;
import com.swc2602.dto.request.UserRequestDto;
import com.swc2602.dto.response.CommentResponseDto;
import com.swc2602.dto.response.FollowResponseDto;
import com.swc2602.dto.response.LikeResponseDto;
import com.swc2602.dto.response.PostResponseDto;
import com.swc2602.dto.response.RetweetResponseDto;
import com.swc2602.dto.response.UserResponseDto;
import com.swc2602.service.AppUserService;
import com.swc2602.service.CommentService;
import com.swc2602.service.FollowService;
import com.swc2602.service.PostLikeService;
import com.swc2602.service.PostService;
import com.swc2602.service.RetweetService;
...
class BackApplicationTests3_Service {
	...
	void setup() {
		...
		UserRequestDto req1 = new UserRequestDto("user1" + UUID.randomUUID() + "@test.com", "pass123", "user1",
				"local");
		UserRequestDto req2 = new UserRequestDto("user2" + UUID.randomUUID() + "@test.com", "pass123", "user2",
				"local");
		...
		PostRequestDto postReq = new PostRequestDto("테스트 게시글", "#tag1,#tag2", null);
	...
	void testPostService() {
		...
		// 게시글 수정
		PostRequestDto updateReq = new PostRequestDto("수정된 게시글", "#newTag", null);
